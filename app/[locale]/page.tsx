...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center bg-cover bg-center min-h-screen w-full mx-auto bg-sky-100 dark:bg-sky-800 sm:bg-[url('/images/BG/bgHomeMorning.jpg')] sm:dark:bg-[url('/images/BG/bgHomeNight.jpg')] ">
