...
export  function MenuSkeleton() {
  return (
    <div className=" flex items-center justify-center bg-cover bg-center w-full max-w-screen-2xl mx-auto min-h-screen bg-sky-100 dark:bg-sky-800 sm:bg-[url('/images/BG/bgMenuMorning.jpg')] sm:dark:bg-[url('/images/BG/bgMenuNight.jpg')] pt-16">
