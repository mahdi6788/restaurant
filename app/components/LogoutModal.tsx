...
export default function LogoutModal({ isOpen, onClose }: CartModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-emerald-900 dark:dark-mode p-6 rounded-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto">
        ...
        <form action={handleSignOut} className="bg-emerald-900">
          <Button type="submit">
          {translate("Sign Out")}
          </Button>
        </form>
