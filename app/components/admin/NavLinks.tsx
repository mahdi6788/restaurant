      ...
      {links.map((link) => {
        ...
        return (
          <Link
            key={link.name}
            href={link.href}
            className={`flex grow items-center justify-center gap-2 rounded-md bg-gray-50 dark:bg-gray-800 p-3 text-lg font-medium hover:bg-sky-100 hover:text-blue-600 sm:flex-none sm:justify-start sm:p-2 sm:px-3",
